...
When do users listen to music most frequently?
Which platforms have the highest engagement?
What factors drive users to skip songs?
How can we improve user retention?
What are the different user behavioral segments?
...
Run the EDA notebook: 01_eda.ipynb
Execute SQL queries in the sql/ directory
Review business insights in 02_business_insights.ipynb
Explore advanced analytics in 03_advanced_analytics.ipynb
Expected Outcomes
